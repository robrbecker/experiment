...
Future<String> loadReleaseNotes() async {
  GitHub github = GitHub(auth: Authentication.withToken('TODO TOKEN'));
  ...
  var unreleasedPRs = await github.search.issues('repo:${slug.fullName} is:pull-request label:unreleased state:closed', sort: 'desc').toList();
